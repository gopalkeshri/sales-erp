...
class Setting extends Model
{
    ...
    public static function defaultSettings(): array
    {
        return [
            ...
            [
                'key' => 'company_name',
                'value' => 'Apex Enterprise Solutions Pvt. Ltd.',
                'group' => 'company',
                'type' => 'string',
            ...
            [
                'key' => 'company_tagline',
                'value' => 'Enterprise B2B Revenue & GST Fulfillment Platform',
                'group' => 'company',
                'type' => 'string',
            ...
            [
                ...
                'group' => 'company',
                'type' => 'string',
                'description' => 'Indian Goods and Services Tax Identification Number (GSTIN)',
            ],
            [
                'key' => 'company_pan',
                'value' => 'AAACA1234F',
            ...
            [
                'key' => 'company_address',
                'value' => '100 Enterprise Tower, BKC Complex',
                'group' => 'company',
                'type' => 'string',
            ...
            [
                ...
                'group' => 'company',
                'type' => 'string',
                'description' => 'GST State Code (e.g. 27 for Maharashtra)',
            ],
            [
            ...
            // Bank & Settlement Details (For GST Tax Invoices)
            [
                'key' => 'bank_name',
                'value' => 'HDFC Bank Ltd.',
                'group' => 'company',
                'type' => 'string',
                'description' => 'Bank Name for NEFT/RTGS payments',
            ],
            [
                'key' => 'bank_account_no',
            ...
            [
                'key' => 'upi_id',
                'value' => 'apexsolutions@okhdfcbank',
                'group' => 'company',
                'type' => 'string',
                'description' => 'UPI VPA Handle for direct mobile payments',
            ],
            ...
            [
                ...
                'group' => 'localization',
                'type' => 'string',
                'description' => 'Base currency code (e.g. INR, USD, EUR, GBP)',
            ],
            [
                'key' => 'currency_symbol',
                'value' => '₹',
